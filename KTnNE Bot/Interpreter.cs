...
namespace KTnNE_Bot
{
    class Interpreter
    {
        ...
        public Interpreter()
        {
            ...
            Recognizer.SetContext(new List<string>{"simple button","simple wires","bomb setup", "new bomb", "keypad", "simon says", "first", "memory", "morse", "complicated wires", "sequential wires", "maze", "password" },1,1);
        }
